...
CONSTRAINT ADMINFK FOREIGN KEY (Id)
	REFERENCES USER(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
CONSTRAINT CUSTOMERFK FOREIGN KEY (Id)
	REFERENCES USER(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
StreetNumber int,
ApartmentNumber int,
CONSTRAINT SHIPPINGRECPK PRIMARY KEY (Name, CustomerId),
CONSTRAINT SHIPPINGRECFK FOREIGN KEY (CustomerId)
...
CustomerId int NOT NULL,
CustomerUsername varchar(255) NOT NULL,
CONSTRAINT SHIPPINGRECPK PRIMARY KEY (ItemId, CustomerId),
CONSTRAINT SHIPPINGREC_ITEMFK FOREIGN KEY (ItemId)
	REFERENCES ITEM(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE,
CONSTRAINT SHIPPINGREC_CUSTOMERFK FOREIGN KEY (CustomerId)
	REFERENCES CUSTOMER(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
CONSTRAINT SHOPPING_CARTFK FOREIGN KEY (CustomerId)
	REFERENCES CUSTOMER(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
CONSTRAINT ORDER_SHOPPINGCARTFK FOREIGN KEY (CartId)
	...
	ON DELETE CASCADE
	ON UPDATE CASCADE,
CONSTRAINT ORDER_CUSTOMERFK FOREIGN KEY (CustomerId)
	REFERENCES CUSTOMER(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE,
...
CustomerId int NOT NULL,
CustomerUsername varchar(255) NOT NULL,
CONSTRAINT SHIPS_ORDERPK PRIMARY KEY (ShipmentCompanyName, OrderId, RecipientName, CustomerId),
...
CONSTRAINT SHIPS_SHIPRECFK FOREIGN KEY (RecipientName)
	...
	ON DELETE CASCADE
	ON UPDATE CASCADE,
CONSTRAINT SHIPS_CUSTOMERFK FOREIGN KEY (CustomerId)
	REFERENCES Customer(Id)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
